...
class map {
  ...
  private:
    ...
    struct node {
      ...
      ///       set_height()
      void rebalance() {
        /// @bonus Finish the implementation of rebalancing of tree utility used
        ///        by AVL trees after an insert or erase
      }
      ...
      ///       code reusability.
      node* restructure() {
        /// @bonus Implement the restructuring utility used to restore balance in 
        ///        a trin-node structure with disbalanced height.
        return this;
      }
